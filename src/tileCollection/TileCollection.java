...
public class TileCollection {
	...
	public TileCollection() {
		...
		tileArray[21] = new Property("Ware House",220 ,18 , 65, new Color(169, 60, 48, 255));
		...
		tileArray[26] = new Property("Cubbler", 260, 22, 80,  new Color(254,231,11, 255));
		...
		tileArray[31] = new Property("Armer", 300, 26, 95, new Color(95,178,77, 255));
		...
		tileArray[39] = new Property("Castle", 400, 50, 200, new Color(4,74,159, 255));		
